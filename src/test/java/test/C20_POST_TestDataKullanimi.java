...
Expected Body
{
    ...
    */
    ...
    public void post01(){
        ...
        JSONObject expBody=testDataHerOkuApp.expectedBodyOlustur();
        ...
        assertEquals(testDataHerOkuApp.okStatusCode,response.getStatusCode());
        ...
        //respJP jasonPath yapisinda oldugu icin kutu acar gibi getJSONObject demeye gerek yok
